...
- **Day 1 QA + watching anchor + SW reload (2026-04-30, mid-event late afternoon)** ✓ — Six fixes shipped together after user reported on-event bugs with live 2026 data:
  ...
  116 tests; live verification pending via chrome-devtools-mcp against https://venom-favorites.web.app. New env: `VITE_TBA_API_KEY`. New localStorage keys: `watching-match/v1`, `last-location/v1`. No existing storage keys touched.
